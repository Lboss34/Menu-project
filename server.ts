...
// Note: Electronic payment features (Tap Payments, Credit Cards) have been removed. All purchases are now Cash on Delivery.
...
app.post('/api/orders/place', async (req, res) => {
  try {
    ...
    // Save order securely to Firestore using server authorization
    console.log('[Secure Order checkout] Saving order to Firestore:', JSON.stringify(newOrder, null, 2));
    try {
